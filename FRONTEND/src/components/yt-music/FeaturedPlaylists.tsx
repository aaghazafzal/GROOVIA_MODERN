        ...
        <div className="relative py-4 md:py-8 md:px-8">
            <div className="flex justify-between items-end mb-4 md:mb-6">
                <div>
                    ...
                    <h2 className="text-2xl md:text-4xl font-bold text-white">Featured Playlists</h2>
                </div>
            ...
            <div ref={scrollRef} className="flex gap-3 md:gap-4 overflow-x-auto scrollbar-hide scroll-smooth -mx-4 px-4 md:mx-0 md:px-0">
                    ...
                    >
                        <div className="relative aspect-square rounded-lg overflow-hidden bg-zinc-800 shadow-md group-hover:shadow-purple-500/20 transition-all duration-300">
                            ...
                            <div className={`fallback-icon absolute inset-0 bg-zinc-800 flex items-center justify-center ${playlist.thumbnails?.[0]?.url ? 'hidden' : 'flex'}`}>
                                <RiPlayListFill className="text-gray-600" size={36} />
                            </div>
                        ...
                        <div className="flex flex-col">
                            <h3 className="text-white font-semibold text-sm md:text-base truncate group-hover:text-purple-400 transition-colors" title={playlist.title}>
                            ...
                            <div className="flex items-center gap-1 text-xs md:text-sm text-gray-400 truncate">
                                ...
                                <span>•</span>
                                <span className="truncate">{playlist.author?.name || playlist.author || 'YouTube Music'}</span>
                            </div>
                        </div>
                    </div>
                ))}
